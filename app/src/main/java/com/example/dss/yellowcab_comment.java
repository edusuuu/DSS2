...
public class yellowcab_comment extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_yellowcab_comment);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(yellowcab_comment.this, activity_yellowcab.class);
                Toast.makeText(yellowcab_comment.this, "Returning...", Toast.LENGTH_SHORT).show();
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (n1.getText().toString().isEmpty() && cm1.getText().toString().isEmpty()){
                    ...
                    Toast.makeText(yellowcab_comment.this, "Comment added!", Toast.LENGTH_SHORT).show();
