    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(chowking_comment.this, Chowking.class);
                Toast.makeText(chowking_comment.this, "Returning...", Toast.LENGTH_SHORT).show();
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (n1.getText().toString().isEmpty() && cm1.getText().toString().isEmpty()){
                    ...
                    Toast.makeText(chowking_comment.this, "Comment added!", Toast.LENGTH_SHORT).show();
