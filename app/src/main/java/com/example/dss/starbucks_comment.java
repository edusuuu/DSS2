...
public class starbucks_comment extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_starbucks_comment);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(starbucks_comment.this, Starbucks.class);
                Toast.makeText(starbucks_comment.this, "Returning...", Toast.LENGTH_SHORT).show();
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (n1.getText().toString().isEmpty() && cm1.getText().toString().isEmpty()){
                    ...
                    Toast.makeText(starbucks_comment.this, "Comment added!", Toast.LENGTH_SHORT).show();
